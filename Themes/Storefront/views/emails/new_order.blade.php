                ...
                <tr>
                    <td style="padding: 0;">
                        <table style="border-collapse: collapse; width: 100%;">
                            <tbody>
                                <tr>
                                    <td align="center" style="background: {{ resolve_theme_color(setting('storefront_mail_theme')) }};">
                                        @if (is_null($logo))
                            ...
                            <tr>
                                <td style="padding: 0;">
                                    ...
                                    >
                                         ...
                                         <?php 
                                        $orderId = $order->id;
                                        $product_id = Illuminate\Support\Facades\DB::table('order_products')->where('order_id', $orderId)->first()->product_id;
                                        // print_r($product_id); exit('kokok');  
                                        $product_name = Illuminate\Support\Facades\DB::table('product_translations')->where('product_id', $product_id)->first()->name;
                                        
                                        ?>
                                        
                                        A new order has been placed. The event is {{$product_name}}. The order id is {{ $order->id }}.
                                        
                                        
                                        {{-- {{ trans('checkout::mail.new_order_text', ['order_id' => $order->id, 'event_name'=>$product_name] ) }}--}}
