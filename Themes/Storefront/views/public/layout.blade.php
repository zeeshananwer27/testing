...
<html lang="{{ locale() }}">
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <script src={{ v(Theme::url('public/js/go-debug.js')) }} ></script>
        <script src={{ v(Theme::url('public/js/pSBC.js')) }} ></script>
        <script src={{ v(Theme::url('public/js/0.global.js')) }} ></script>
        <script src={{ v(Theme::url('public/js/1.Handlers.js')) }} ></script>
        <script src={{ v(Theme::url('public/js/2.Shapes.js')) }} ></script>
        <script src={{ v(Theme::url('public/js/4.Utilities.js')) }} ></script>
        <script src={{ v(Theme::url('public/js/5.Getters.js')) }} ></script>
        <script src={{ v(Theme::url('public/js/6.Removers.js')) }} ></script>
        <script src={{ v(Theme::url('public/js/7.Updaters.js')) }} ></script>
        <script src={{ v(Theme::url('public/js/9.EventListeners.js')) }} ></script>
    ...
    <body class="{{ $theme }} {{ storefront_layout() }} {{ is_rtl() ? 'rtl' : 'ltr' }}" onload="init()">
        <!--[if lt IE 8]>
        ...
        <div class="main">
            <div class="wrapper">
                ...
                <div class="content-wrapper {{ request()->routeIs('cart.index') ? 'cart-page' : '' }}">
