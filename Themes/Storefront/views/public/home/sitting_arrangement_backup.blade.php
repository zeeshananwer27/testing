...
<html>
   <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
      ...
      -->      
      <link rel="shortcut icon" href="<?php echo url('/public/modules/sitting_arrangements/assets/images/logo.png') ?>" />
      <!-- <link href="https://unpkg.com/gijgo@1.9.13/css/gijgo.min.css" rel="stylesheet" type="text/css" />
      <link rel="stylesheet" href="https://cdn.datatables.net/1.10.20/css/jquery.dataTables.min.css"> -->
      <link rel="stylesheet" href="<?php echo url('/public/modules/sitting_arrangements/assets/css/bootstrap-grid.min.css') ?>" type="text/css" />
      <link rel="stylesheet" href="<?php echo url('/public/modules/sitting_arrangements/assets/css/bootstrap.min.css') ?>" type="text/css" />
      <link rel="stylesheet" href="<?php echo url('/public/modules/sitting_arrangements/assets/css/bootstrap-reboot.min.css') ?>" type="text/css" />
      <link rel="stylesheet" href="<?php echo url('/public/modules/sitting_arrangements/assets/css/font-awesome.min.css') ?>" type="text/css" />
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/rangeslider-pure@0.4.4/dist/range-slider.css">
      <link rel="stylesheet" href="<?php echo url('/public/modules/sitting_arrangements/assets/icons/flaticon.css') ?>" type="text/css" />
      <link rel="stylesheet" href="<?php echo url('/public/modules/sitting_arrangements/assets/css/style.css') ?>" type="text/css" />
      <link rel="stylesheet" href="<?php echo url('/public/modules/sitting_arrangements/assets/css/tiersColorPickerCircles.css') ?>" type="text/css" />
      <link rel="stylesheet" href="<?php echo url('/public/modules/sitting_arrangements/assets/css/holdsColorPickerCircles.css') ?>" type="text/css" />
      <link rel="stylesheet" href="<?php echo url('/public/modules/sitting_arrangements/assets/css/colorPicker.css') ?>" type="text/css" />
      <script src="<?php echo url('/public/modules/sitting_arrangements/go-library/go-debug.js') ?>"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/GroupRotatingTool.js') ?>"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/pSBC.js') ?>"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/components/0.global.js') ?>"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/components/1.Handlers.js') ?>"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/components/2.Shapes.js') ?>"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/components/3.Models.js') ?>"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/components/4.Utilities.js') ?>"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/components/5.Getters.js') ?>"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/components/6.Removers.js') ?>"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/components/7.Updaters.js') ?>"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/components/8.Validators.js') ?>"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/components/9.EventListeners.js') ?>"></script>
                        ...
                        <ul class="nav nav-pills setting_tabs">
                           <li class="nav-item" data-toggle="tooltip" data-placement="bottom" title="Add a section">
                              <a class="nav-link active" data-toggle="pill"
                                 ...
                                 'menu1'})"> 
                              <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/t5.png') ?>" class="d-block
                                 mx-auto" alt="" />
                              <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/t1.png') ?>" class="d-none
                           ...
                           <li class="nav-item" data-toggle="tooltip" data-placement="bottom" title="Add a table">
                              <a class="nav-link" data-toggle="pill" href="#menu2"
                                 onclick="Helper__HideOrShowCapacityMenu({elementID:
                                 'menu2'})">
                              <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/t2.png') ?>" class="d-block
                                 mx-auto" alt="" />
                              <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/t1.png') ?>" class="d-none
                                 mx-auto add_icon" alt="" />
                              Table
                           ...
                           <li class="nav-item" data-toggle="tooltip" data-placement="bottom" title="Add an object">
                              <a class="nav-link" data-toggle="pill" href="#menu3"
                                 onclick="Helper__HideOrShowCapacityMenu({elementID:
                                 'menu3'})">
                              <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/t3.png') ?>" class="d-block
                                 mx-auto" alt="" />
                                 <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/t1.png') ?>" class="d-none
                                 mx-auto add_icon" alt="" />
                              Object
                           ...
                           <li class="nav-item" data-toggle="tooltip" data-placement="bottom" title="Add text">
                              <a class="nav-link" data-toggle="pill" href="#menu4"
                                 onclick="Helper__HideOrShowCapacityMenu({elementID:
                                 'menu4'})">
                              <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/t4.png') ?>" class="d-block
                                 mx-auto" alt="" />
                                 <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/t1.png') ?>" class="d-none
                                 mx-auto add_icon" alt="" />
                              Text
                                 ...
                                 <div class="GeneralAdmission siting_options">
                                    <p class="capacity sit pt-1">
                                       ...
                                       <input type="radio" name="type1" id="seating"
                                          class="input-hidden">
                                       <label for="seating">
                                       <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/tt1.png') ?>" alt="a"
                                       ...
                                       <label for="standing">
                                       <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/tt2.png') ?>" alt="c">
                                       </label>
                                       </span>
                                    </p>
                              ...
                              <div class="selection_content mt-0 float-none">
                                 <div class="card mb-3 border-0">
                                    <div class="row no-gutters">
                                       <div class="col-auto">
                                          <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/list.png') ?>"
                              ...
                              <div class="setting_tabs siting_edit_btn">
                                 <div class="row no-gutters">
                                    <div class="col">
                                       ...
                                       <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/pencil.png') ?>"
                                          class="mx-auto" alt="">
                                       Edit
                                       </a>
                                    </div>
                                    <div class="col">
                                       ...
                                       <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/plus.png') ?>"
                                          class="mx-auto" alt="">
                                       Duplicate
                                       </a>
                                    </div>
                                    <div class="col">
                                       ...
                                       <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/del.png') ?>"
                                          class="mx-auto" alt="">
                                       Delete
                                       </a>
                                    </div>
                              ...
                              <div class="selection_content mt-0">
                                 ...
                                 <div class="tab-content">
                                    <div class="tab-pane active" id="layout">
                                       <div class="set1 siting_options mt-3">
                                          ...
                                          <p class="capacity sit">
                                             ...
                                             <input type="radio" name="align"
                                                ...
                                                />
                                             <label for="align2">
                                             <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/t7.png') ?>"
                                                alt="c" />
                                             </label>
                                             </span>
                                             <span>
                                             ...
                                             <label for="align1">
                                             <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/t6.png') ?>"
                                                alt="a" />
                                             </label>
                                             </span>
                                          </p>
                                       ...
                                       <div class="container1">
                                          <div class="row d-flex h-100 my-3">
                                             <div class="col-auto align-self-center">
                                       ...
                                       <div class="main-contents">
                                          ...
                                          <div class="set1 siting_options">
                                             ...
                                             <p class="capacity sit pt-1 border-bottom
                                                ...
                                                <label for="dir1">
                                                <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/arrow.png') ?>"
                                                   class="r-180" alt="c">
                                                </label>
                                                </span>
                                                <span>
                          ...
                          <div class="tab-pane active">
                            <div class="selection_content mt-0 float-none">
                                <div class="mb-3">
                                  <div class="row no-gutters">
                                      <div class="col-auto">
                                        <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/t4.png') ?>"
                                            class="card-img" alt="list">
                                      </div>
                                      <div class="col">
                                        <div class="card-body p-0 pl-2">
                           ...
                           <div class="tab-pane active">
                              <div class="selection_content mt-0 float-none">
                                 <div class="card mb-3 border-0">
                                    <div class="row no-gutters">
                                       <div class="col-auto">
                                          <img src="<?php echo url('/public/modules/sitting_arrangements/assets/images/t2.png') ?>"
                                             class="card-img" alt="list">
                                       </div>
                                       <div class="col">
                                          <div class="card-body p-0 pl-2">
...
<div class="selection_content d-none" id="holdsGeneralAdmission">
                                    ...
                                    <div class="row">
                                       <div class="col-md-6 col-sm-12">
                                          <div class="form-group">
                                             ...
                                             <input  class="form-control" id="accessCodeDatePicker">
                                             </div>
                                       ...
                                       <div class="col-md-6 col-sm-12">
                                          <div class="form-group">
                                             ...
                                             <input  class="form-control" id="accessCodeTimePicker">
                                             </div>
                                       </div>
                                    </div>
                                    <div class="row">
      ...
      <!-- Modal End -->  
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/jquery.js') ?>" type="text/javascript"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/popper.js') ?>" type="text/javascript"></script>
      <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
      <script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js"></script>
      <script src="<?php echo url('/public/modules/sitting_arrangements/assets/js/bootstrap.min.js') ?>" type="text/javascript"></script>
