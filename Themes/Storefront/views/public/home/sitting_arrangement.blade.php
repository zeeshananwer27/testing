...
<html>
   ...
   <link rel="stylesheet" href="<?php echo url('modules/sitting_arrangements/assets/css/loader.css') ?>" type="text/css" />
   ...
   <body onload="init()">
      ...
      <div class="col-12 py-3 pl-5">
         <div class="row">
            ...
            <div class="col-auto text-center" id="saveButtonsWrapper">
               <div class="tab-header">
                  <button class="btn btn-outline mr-2" id="saveAsTemplate">Save As Template</button>
         ...
         <div class="tab-pane active show">
            <div class="row">
               <div class="col-md-7 col-lg-9 px-0">
                  ...
                  <div id="loading" style="display:none;position: fixed;height: 100%;width: 100%;top: 0;left: 0;background: #9191927a;z-index: 9999;font-size: 65px;text-align: center;padding-top: 200px;color: #fff;font-family: tahoma;">
                       <img src="{{asset('gif/loader.gif')}}" border="0">
                   </div>
                  ...
                  <div class="canvas_setting" id="map">
                     <div class="canvas_set_main" id="capacity">
                        ...
                        <ul class="nav nav-pills setting_tabs">
                           <li class="nav-item" data-toggle="tooltip" data-placement="bottom" title="Add section">
                           ...
                           <li class="nav-item" data-toggle="tooltip" data-placement="bottom" title="Add table">
                           ...
                           <li class="nav-item" data-toggle="tooltip" data-placement="bottom" title="Add object">
                           ...
                           <li class="nav-item" data-toggle="tooltip" data-placement="bottom" title="Add text">
                              <a class="nav-link" data-toggle="pill" href="#menu4"
                                 onclick="Helper__HideOrShowCapacityMenu({elementID: 'menu4'})">
                              <img src="<?php echo url('modules/sitting_arrangements/assets/images/t4.png') ?>" class="d-block mx-auto" alt="" />
                                 <img src="<?php echo url('modules/sitting_arrangements/assets/images/t1.png') ?>" class="d-none mx-auto add_icon" alt="" />
                              Text
                              </a>
                           </li>
                            <li class="nav-item" data-toggle="tooltip" data-placement="bottom" title="Add template">
                                <a class="nav-link" data-toggle="pill" href="#menu5" id="templatesDisplayButton">
                                    <i class="fa fa-clone d-block"></i>
                                    <img src="<?php echo url('modules/sitting_arrangements/assets/images/t1.png') ?>" class="d-none  mx-auto add_icon" alt="" />
                                    Templates
                                </a>
                            </li>
                        ...
                        <div class="tab-content">
                           ...
                           <div class="tab-pane fade" id="menu4">
                            ...
                            <div class="tab-pane fade" id="menu5">
                                <div class="selection_content">
                                    <p class="text-center"><u>Templates</u></p>
                                    <div class="row text-justify-center">
                                        <div class="col-md-12 align-self-center" id="templatesArea">
                                        </div>
                                    </div>
                                </div>
                                <div class="row no-gutters justify-content-center my-2">
                                    <div class="col-5">
                                        <div class="seats_btn">
                                            <button class="btn btn-danger bg-none closed" data-target="#edit" onclick="Helper__clearSelection()">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                              ...
                              <div class="selection_content mt-0 float-none">
                                 <div class="card mb-3 border-0">
                                    <div class="row no-gutters">
                                       <div class="col-auto">
                                          <img src="<?php echo url('modules/sitting_arrangements/assets/images/list.png') ?>"  class="card-img" alt="list">
                                       </div>
                                       <div class="col">
      ...
      <!-- Images base64 -->
      @php
         $images ['tt1']= strval(('data:image/png;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/tt1.png'))));
         $images ['tt2']= strval(('data:image/png;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/tt2.png'))));
         $images ['open-eyes']= strval(('data:image/png;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/open-eyes.png'))));
         $images ['closed-eyes']= strval(('data:image/png;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/closed-eyes.png'))));
         $images ['microphone']= strval(('data:image/png;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/microphone.png'))));
         $images ['food']= strval(('data:image/png;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/food.png'))));
         $images ['drink']= strval(('data:image/png;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/drink.png'))));
         $images ['bathroom']= strval(('data:image/png;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/bathroom.png'))));
         $images ['exit']= strval(('data:image/png;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/exit.png'))));
         $images ['dance']= strval(('data:image/png;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/dance.png'))));
         $images ['american-football']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/american-football.svg'))));
         $images ['baseball']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/baseball.svg'))));
         $images ['basketball']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/basketball.svg'))));
         $images ['boxing']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/boxing.svg'))));
         $images ['cricket']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/cricket.svg'))));
         $images ['hockey']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/hockey.svg'))));
         $images ['lacrosse']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/lacrosse.svg'))));
         $images ['rugby']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/rugby.svg'))));
         $images ['soccer']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/soccer.svg'))));
         $images ['swimming']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/swimming.svg'))));
         $images ['tennis']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/tennis.svg'))));
         $images ['track']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/track.svg'))));
         $images ['volleyball']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/volleyball.svg'))));
         $images ['volleyball']= strval(('data:image/svg+xml;base64,'.base64_encode(file_get_contents('modules/sitting_arrangements/assets/images/volleyball.svg'))));
      @endphp
      <!-- Images base64 End -->
    ...
    @endif
        ...
        @if($sitting_arrangement)
            window.dataDiagram = <?php echo $sitting_arrangement; ?>;
        @endif
    
        @if($event_templates)
            window.eventTemplates = <?php echo $event_templates; ?>;
        @endif
        var imagesInString= {};
        <?php foreach($images as $key => $val){ ?>
            imagesInString['<?php echo $key; ?>'] = '<?php echo $val; ?>';
        <?php } ?>
    </script>
   </body>
</html>
