...
<div id="address" class="tab-pane active" role="tabpanel">
    <div class="box-wrapper address clearfix">
        <div class="box-header">
            <h4>{{ trans('storefront::checkout.tabs.address') }}
                <button type="button" class="btn btn-primary next-step continue-button pull-right custom_botton " style = "margin:-10px !important">{{ trans('storefront::checkout.continue') }}</button>
            </h4>
        </div>
        ...
        <div class="personal-information clearfix">
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('customer_email') ? 'has-error': '' }}">
                    ...
                    <input type="text" name="customer_email" class="form-control" id="customer-email" value="<?php echo isset($user->email) ? $user->email : ''; ?>">
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('customer_phone') ? 'has-error': '' }}">
                    <label for="customer-phone">
                        {{ trans('storefront::checkout.tabs.attributes.customer_phone') }}<span>*</span>
                    </label>

                    <input type="text" name="customer_phone" class="form-control" id="customer-phone" value="<?php echo isset($user_info->customer_phone) ? $user_info->customer_phone : ''; ?>">
            ...
            @guest
                ...
                <!--    <div class="create-account clearfix">-->
                        <!--<div class="checkbox">-->
                <!--            <input type="hidden" name="create_an_account" value="1">-->
                        ...
                        <!--<div class="form-group {{ old('create_an_account') ? '' : '' }}">-->
        ...
        <!--</button>-->
        <button type="button" class="btn btn-primary next-step continue-button pull-right custom_button_bottom">
            {{ trans('storefront::checkout.continue') }}
        </button>
    </div>
</div>
