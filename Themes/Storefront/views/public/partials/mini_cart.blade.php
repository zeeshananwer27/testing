    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu">
            ...
            <div class="mini-cart">
                ...
                // dd(session()->all());
                // $sess = session()->all();
                // dd($sess->CartCollection);
                // echo "<pre>"; print_r($sess->CartCollection); //print_r($sess->toArray());
                        ...
                        <div class="mini-cart-item clearfix">
                            ...
                            <div class="mini-cart-details clearfix">
                                ...
                                <form method="POST" action="{{ route('cart.items.destroy', encrypt($cartItem->id)) }}" onsubmit="return confirm('{{ trans('cart::messages.confirm') }}');">
                                    ...
                                    <button type="submit" class="btn-close" data-toggle="tooltip" data-placement="{{ is_rtl() ? 'right' : 'left' }}" title="{{ trans('storefront::layout.mini_cart.remove') }}">
                                        &times;
                                    </button>
                                </form>
                            </div>
