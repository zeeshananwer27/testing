                        ...
                        <div class="cart-list">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    @php
                                        $seat_data=json_decode($order->options_data,true);
                                    @endphp
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ $order->sub_total->format($order->currency) }}</td>
                                    </tr>

{{--                                    @if ($order->hasShippingMethod())--}}
{{--                                        <tr>--}}
{{--                                            <td>{{ $order->shipping_method }}</td>--}}
{{--                                            <td>{{ $order->shipping_cost->format($order->currency) }}</td>--}}
{{--                                        </tr>--}}
{{--                                    @endif--}}
                                    ...
                                    @if ($order->hasCoupon())
                                        <tr>
                                            ...
                                            <td>&#8211;{{ $order->discount->format($order->currency) }}</td>
                                        </tr>
                                    @endif
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $order->total->format($order->currency) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
