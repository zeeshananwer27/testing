...
class Order extends Model
{
    ...
    public static function totalSales()
    {
        ...
        $total = static::whereIn('id', $orders)->whereNotIn('status', ['canceled', 'refunded'])->sum('total');
    ...
    public function table()
        ...
        'pt.organizer',
        'pt.name',
        DB::raw ('DATE_FORMAT(products.start_event, "%m-%d-%Y") as start_event'),
        // 'product_translations.start_event',
        // 'DATE_FORMAT(product_translations.start_event, "%d-%b-%Y") as start_event',
        ]);
