<script type="text/html" id="slide-template">
    <div class="slide">
        <div class="slide-header clearfix">
            ...
            <span class="pull-left">{{ trans('slider::sliders.slide.image_slide') }}</span>
                ...
                <div class="tab-content">
                    ...
                    <div id="slider-<%- slideNumber %>-options" class="tab-pane fade in clearfix">
                        <select class="change-option-block custom-select-black pull-right">
                            ...
                            <option value="caption-3">{{ trans('slider::sliders.slide.form.caption_3') }}</option>
                        ...
                        @include('slider::admin.sliders.templates.partials.slide_caption', ['captionNumber' => 3])
